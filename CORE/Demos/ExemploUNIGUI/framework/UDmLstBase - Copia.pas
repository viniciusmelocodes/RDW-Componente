...
uses
  ...
  FireDAC.Comp.Client, FireDAC.Comp.DataSet, uRestPoolerDB;
...
type
  TDmLstBase = class(TDmBase)
    ...
    qryCadbase: TRESTClientSQL;
    qryLstbase: TRESTClientSQL;
  private
  ...
  public
    ...
    AutoInc: Boolean;
    procedure CarregaSql(Tabela: string; intTipo: Integer);
  end;
